...
public class SetOrderPaySchResult extends Base<SetOrderPaySchResult>{

	/**
	 * 
	 */
	private static final long serialVersionUID = -164256513018317272L;
	...
	@JsonProperty("z_orderpaymschedule_id")
	public Integer z_orderpaymschedule_id;
	...
	static
	{
		...
		ERRORS.put(E010,"Document IN OUT non trouvé ");
		ERRORS.put(E011,"Document order non trouvé");
		ERRORS.put(E012,"type echeance non trouvé");
		ERRORS.put(E020,"Type de document non trouvé" );
		ERRORS.put(E030,"Nom du fichier attaché nécessaire" );
		ERRORS.put(E031,"Date d'échéance non conforme" );
		ERRORS.put(E040,"Magasin non trouvé" );
		ERRORS.put(E041,"Montant inchérent" );
		ERRORS.put(E050,"Action document inconnue" );
		ERRORS.put(E051,"Impossible de créer l'échéance dans SMILE" );
		...
		ERRORS.put(E507,"Echéance créé" );
		ERRORS.put(E508,"Ligne OA obligatoire pour réception OA" );
