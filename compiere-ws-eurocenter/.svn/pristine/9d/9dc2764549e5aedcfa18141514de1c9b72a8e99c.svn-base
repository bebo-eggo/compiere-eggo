	...
	public SetOrderResult setExtraDatas(OrderLinesDetails datas) {
		...
		try {
			...
			if(!datas.int_code.equals("200"))
			{
				...
				ret.error = "E620";
				ret.errordesc = "Erreur intégration, données non récupérables";
				return ret;
			}
			if(datas.C_Order_ID==null || !NumberUtils.isNumber(datas.C_Order_ID) || Integer.parseInt(datas.C_Order_ID)<=0)
			{
				ret.error = "E601";
				ret.errordesc = "c_order_id Non numérique ou <=0";
				return ret;
			}
			...
			{
				ret.error = "E602";
				ret.errordesc = "Vente non trouvée";
				return ret;
			}
			...
			{
				ret.error = "E603";
				ret.errordesc = "c_orderline_id Non numérique  ou <=0";
				return ret;
			}
			...
			{
				ret.error = "E604";
				ret.errordesc = "Ligne de vente non trouvée";
				return ret;
			}
			...
			{
				ret.error = "E605";
				ret.errordesc = "Aucune ligne de détails à créer";
				return ret;
			}
			else {
		...
		ret.error = "E200";
		ret.errordesc = "Lignes de détails créée : "+nb;
