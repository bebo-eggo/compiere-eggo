...
public class SetInOutResult extends Base<SetInOutResult>{
	...
	public Integer m_InOut_ID;
	
	@JsonProperty("DocumentNo")
	public String documentNo;
	
	public SetInOutResult() {
	...
	static
	{
		...
		ERRORS.put(E051,"Impossible de créer le InOUt" );
		...
		ERRORS.put(E507,"InOut créé" );
		ERRORS.put(E508,"Ligne OA obligatoire pour réception OA" );
		ERRORS.put(E509,"Ligne OA désactivée : " );
