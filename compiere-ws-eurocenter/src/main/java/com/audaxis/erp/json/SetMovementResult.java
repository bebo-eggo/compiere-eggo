...
public class SetMovementResult extends Base<SetMovementResult>{
	...
	public final static String E510 = "510";
	...
	static
	{
		...
		ERRORS.put(E010,"Document Transfert non trouvé ");
		...
		ERRORS.put(E510,"Impossible de supprimer les lignes" );
