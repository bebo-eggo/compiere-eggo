...
public class SetOrderDownloadResult extends Base<SetOrderDownloadResult>{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2536057272750687950L;
	...
	@JsonProperty("c_orderdownload_id")
	public Integer c_OrderDownload_ID;

	@JsonInclude(JsonInclude.Include.NON_NULL) 
	@JsonProperty("")
	public String orders;
	
	public SetOrderDownloadResult() {
	...
	static
	{
		...
		ERRORS.put(E031,"Date creation non conforme" );
		ERRORS.put(E040,"Magasin non trouvé" );
		ERRORS.put(E041,"URL non renseignée" );
		ERRORS.put(E050,"Action document inconnue" );
		ERRORS.put(E051,"Impossible de créer le Fichier attaché Smile" );
		...
		ERRORS.put(E507,"Fichier attaché créé" );
