 ...
 * 
 */
public class PlanningWindowImpl extends WindowImpl {
	 ...
	 * @param U_Window_ID
	 */
	public PlanningWindowImpl(int windowNO, Ctx serverCtx, WindowCtx windowCtx,
			UWindowID uid) {
	...
	public ClientWindowType getClientWindowType() {
		return ClientWindowType.AUDAXIS_PLANNING;
	}
