 ...
 * 
 */
public class CalendarWindowImpl extends WindowImpl {
	 ...
	 * @param U_Window_ID
	 */
	public CalendarWindowImpl(int windowNO, Ctx serverCtx, WindowCtx windowCtx,
			UWindowID uid) {
	...
	public ClientWindowType getClientWindowType() {
		return ClientWindowType.AUDAXIS_CALENDAR;
	}
