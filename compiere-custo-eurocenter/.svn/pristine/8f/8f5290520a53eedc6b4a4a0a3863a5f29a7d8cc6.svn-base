CREATE OR REPLACE FORCE VIEW "RV_ORDERDETAIL_EC" ("AD_CLIENT_ID", "AD_ORG_ID", "ISACTIVE", "CREATED", "CREATEDBY", "UPDATED", "UPDATEDBY", "C_ORDER_ID","I_POSORDER_ID","DOCSTATUS", "DOCACTION", "C_DOCTYPE_ID", "ISAPPROVED", "ISCREDITAPPROVED", "SALESREP_ID", "BILL_BPARTNER_ID", "BILL_LOCATION_ID", "BILL_USER_ID", "ISDROPSHIP", "POREFERENCE", "C_CURRENCY_ID", "ISSOTRX", "C_BPARTNER_ID", "C_BPARTNER_LOCATION_ID", "AD_USER_ID", "C_BP_GROUP_ID", "C_CAMPAIGN_ID", "C_PROJECT_ID", "C_ACTIVITY_ID", "C_PROJECTPHASE_ID", "C_PROJECTTASK_ID", "C_ORDERLINE_ID","I_POSORDERLINE_ID","DATEORDERED", "DATEPROMISED", "M_PRODUCT_ID", "M_WAREHOUSE_ID", "M_ATTRIBUTESETINSTANCE_ID", "PRODUCTATTRIBUTENAME", "M_ATTRIBUTESET_ID", "M_LOT_ID", "GUARANTEEDATE", "LOT", "SERNO", "M_PRODUCT_CATEGORY_ID", "C_UOM_ID", "QTYINPROCESS", "QTYENTERED", "QTYORDERED", "QTYRESERVED", "QTYDELIVERED", "QTYINVOICED", "PRICEACTUAL", "PRICEENTERED", "QTYTODELIVER", "QTYTOINVOICE", "NETAMTTOINVOICE", "QTYLOSTSALES", "AMTLOSTSALES", "DISCOUNT", "MARGIN", "MARGINAMT", "ADDRESS1", "ADDRESS2", "CITY", "POSTAL", "C_REGION_ID", "C_COUNTRY_ID", "ISRETURNTRX", "LINENETAMT", "LINE", "DESCRIPTION", "TAX", "QTYRETURNED", "ISRETURNED", "Z_GRANDTOTAL","ISPREPARED") AS 
  SELECT l.AD_Client_ID                           AS AD_Client_ID,
    ...
    o.i_posorder_id                               AS I_PosOrder_ID,
    ...
    l.I_PosOrderline_ID                           AS I_PosOrderline_ID,
