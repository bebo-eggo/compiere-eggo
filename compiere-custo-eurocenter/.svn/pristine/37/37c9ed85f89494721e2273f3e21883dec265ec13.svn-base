 ...
 *
 *  @author Jorg Janke
 *  @version $Id: Compiere.java 8855 2010-05-28 19:26:28Z freyes $
 */
public final class Compiere
{
	/** Main Version String         */
	static public final String	MAIN_VERSION	= "Release 3.6.1";
	/** Detail Version as date      Used for Client/Server		*/
	static public final String	DATE_VERSION	= "2010-05-31";
	/** Database Version as date    Compared with AD_System		*/
	static public final String	DB_VERSION		= "2010-05-31";
	...
	public static boolean startupEnvironment (boolean isClient, String info)
	{
		...
		//PosCtx.setConstants(Env.getCtx(), null);
		//EggoCtx.setConstants(Env.getCtx().getAD_Client_ID());
		//BBR : TEST CONSTANT EC
		return true;
	}	//	startupEnvironment
