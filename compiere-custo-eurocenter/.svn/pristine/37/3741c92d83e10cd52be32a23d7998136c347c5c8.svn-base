	...
	protected String doIt () throws Exception
	{
		...
		if (p_CopyOverwriteAcct)
		{
			sql = "UPDATE M_Product_Category_Acct pa "
				...
				//Redmine 15386
				+ ", Z_P_PPVOffset_Acct = " + acct.get_ValueAsInt("Z_P_PPVOffset_Acct")
				+ ", W_Differences_Acct = " + acct.get_ValueAsInt("W_Differences_Acct")
				+ ", Z_Production_Discrepency_Acct = " + acct.get_ValueAsInt("Z_Production_Discrepency_Acct")
				//Redmine 15386
		...
		{
			sql = "UPDATE M_Product_Category_Acct pa "
				+ "SET P_Revenue_Acct= COALESCE(pa.P_Revenue_Acct, " + acct.getP_Revenue_Acct() + ")"
				+ ", P_Expense_Acct= COALESCE(pa.P_Expense_Acct, " + acct.getP_Expense_Acct() + ")"
				+ ", P_CostAdjustment_Acct= COALESCE(pa.P_CostAdjustment_Acct, " + acct.getP_CostAdjustment_Acct() + ")"
				+ ", P_InventoryClearing_Acct= COALESCE(pa.P_InventoryClearing_Acct, " + acct.getP_InventoryClearing_Acct() + ")"
				+ ", P_Asset_Acct= COALESCE(pa.P_Asset_Acct, " + acct.getP_Asset_Acct() + ")"
				+ ", P_COGS_Acct= COALESCE(pa.P_COGS_Acct, " + acct.getP_COGS_Acct() + ")"
				+ ", P_PurchasePriceVariance_Acct= COALESCE(pa.P_PurchasePriceVariance_Acct, " + acct.getP_PurchasePriceVariance_Acct() + ")"
				+ ", P_InvoicePriceVariance_Acct= COALESCE(pa.P_InvoicePriceVariance_Acct, " + acct.getP_InvoicePriceVariance_Acct() + ")"
				+ ", P_TradeDiscountRec_Acct= COALESCE(pa.P_TradeDiscountRec_Acct, " + acct.getP_TradeDiscountRec_Acct() + ")"
				+ ", P_TradeDiscountGrant_Acct= COALESCE(pa.P_TradeDiscountGrant_Acct, " + acct.getP_TradeDiscountGrant_Acct() + ")"
				+ ", P_Resource_Absorption_Acct= COALESCE(pa.P_Resource_Absorption_Acct, " + acct.getP_Resource_Absorption_Acct() + ")"
				+ ", P_MaterialOverhd_Acct = COALESCE(pa.P_MaterialOverhd_Acct, " + acct.getP_MaterialOverhd_Acct() + ")"
				//Redmine 15386
				+ ", Z_P_PPVOffset_Acct = COALESCE(pa.Z_P_PPVOffset_Acct, " +  acct.get_Value("Z_P_PPVOffset_Acct") + ")"
				+ ", W_Differences_Acct = COALESCE(pa.W_Differences_Acct, " +  acct.get_Value("W_Differences_Acct") + ")"
				+ ", Z_Production_Discrepency_Acct = COALESCE(pa.Z_Production_Discrepency_Acct, " +  acct.get_Value("Z_Production_Discrepency_Acct") + ")"
				//Redmine 15386
				+ ", Updated=SysDate, UpdatedBy=0 "
				+ "WHERE pa.C_AcctSchema_ID=" + p_C_AcctSchema_ID
				+ " AND EXISTS (SELECT * FROM M_Product_Category p "
		...
		sql = "INSERT INTO M_Product_Category_Acct "
			...
			//Redmine 15386
			+ " Z_P_PPVOffset_Acct, W_Differences_Acct, Z_Production_Discrepency_Acct) "
			//Redmine 15386
			...
			//Redmine 15386
			+ " acct.Z_P_PPVOffset_Acct, acct.W_Differences_Acct, acct.Z_Production_Discrepency_Acct "
			//Redmine 15386
		...
		if(p_UpdateNullAccount) //Update Null accounts only
		{
			sql = "UPDATE M_Product_Acct pa "
				...
				+ ", P_MaterialOverhd_Acct = COALESCE(pa.P_MaterialOverhd_Acct, " + acct.getP_MaterialOverhd_Acct() + ")"
				//Redmine 15386
				+ ", Z_P_PPVOffset_Acct = COALESCE(pa.Z_P_PPVOffset_Acct, " + acct.get_ValueAsInt("Z_P_PPVOffset_Acct") + ")"
				//Redmine 15386
				+ ", Updated=SysDate, UpdatedBy=0 "
				+ "WHERE pa.C_AcctSchema_ID=" + p_C_AcctSchema_ID
		...
		{
			sql = "UPDATE C_BP_Group_Acct a "
				+ "SET C_Receivable_Acct= COALESCE(a.C_Receivable_Acct, " + acct.getC_Receivable_Acct() + ")"
				+ ", C_Receivable_Services_Acct= COALESCE(a.C_Receivable_Services_Acct, " + acct.getC_Receivable_Services_Acct() + ")"
				+ ", C_Prepayment_Acct= COALESCE(a.C_Prepayment_Acct, " + acct.getC_Prepayment_Acct() + ")"
				+ ", V_Liability_Acct= COALESCE(a.V_Liability_Acct, " + acct.getV_Liability_Acct() + ")"
				+ ", V_Liability_Services_Acct= COALESCE(a.V_Liability_Services_Acct, " + acct.getV_Liability_Services_Acct() + ")"
				+ ", V_Prepayment_Acct= COALESCE(a.V_Prepayment_Acct, " + acct.getV_Prepayment_Acct() + ")"
				+ ", PayDiscount_Exp_Acct= COALESCE(a.PayDiscount_Exp_Acct, " + acct.getPayDiscount_Exp_Acct() + ")"
				+ ", PayDiscount_Rev_Acct= COALESCE(a.PayDiscount_Rev_Acct, " + acct.getPayDiscount_Rev_Acct() + ")"
				+ ", WriteOff_Acct= COALESCE(a.WriteOff_Acct, " + acct.getWriteOff_Acct() + ")"
				+ ", NotInvoicedReceipts_Acct= COALESCE(a.NotInvoicedReceipts_Acct, " + acct.getNotInvoicedReceipts_Acct() + ")"
				+ ", UnEarnedRevenue_Acct= COALESCE(a.UnEarnedRevenue_Acct, " + acct.getUnEarnedRevenue_Acct() + ")"
				+ ", NotInvoicedRevenue_Acct= COALESCE(a.NotInvoicedRevenue_Acct, " + acct.getNotInvoicedRevenue_Acct() + ")"
				+ ", NotInvoicedReceivables_Acct= COALESCE(a.NotInvoicedReceivables_Acct, " + acct.getNotInvoicedReceivables_Acct() + ")"
				+ ", Updated=SysDate, UpdatedBy=0 "
				+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
				+ " AND EXISTS (SELECT * FROM C_BP_Group_Acct x "
					+ "WHERE x.C_BP_Group_ID=a.C_BP_Group_ID)";
		...
		{
			sql = "UPDATE C_BP_Employee_Acct a "
				+ "SET E_Expense_Acct= COALESCE(a.E_Expense_Acct, " + acct.getE_Expense_Acct() + ")"
				+ ", E_Prepayment_Acct= COALESCE(a.E_Prepayment_Acct, " + acct.getE_Prepayment_Acct() + ")"
				+ ", Updated=SysDate, UpdatedBy=0 "
				+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
				+ " AND EXISTS (SELECT * FROM C_BP_Employee_Acct x "
					+ "WHERE x.C_BPartner_ID=a.C_BPartner_ID)";
		...
		{
			sql = "UPDATE M_Warehouse_Acct a "
				+ "SET W_Inventory_Acct= COALESCE(a.W_Inventory_Acct, " + acct.getW_Inventory_Acct() + ")"
				+ ", W_Differences_Acct= COALESCE(a.W_Differences_Acct, " + acct.getW_Differences_Acct() + ")"
				+ ", W_Revaluation_Acct= COALESCE(a.W_Revaluation_Acct, " + acct.getW_Revaluation_Acct() + ")"
				+ ", W_InvActualAdjust_Acct= COALESCE(a.W_InvActualAdjust_Acct, " + acct.getW_InvActualAdjust_Acct() + ")"
				+ ", Updated=SysDate, UpdatedBy=0 "
				+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
				+ " AND EXISTS (SELECT * FROM M_Warehouse_Acct x "
					+ "WHERE x.M_Warehouse_ID=a.M_Warehouse_ID)";
		...
		{
			sql = "UPDATE C_Project_Acct a "
				+ "SET PJ_Asset_Acct= COALESCE(a.PJ_Asset_Acct, " + acct.getPJ_Asset_Acct() + ")"
				+ ", PJ_WIP_Acct= COALESCE(a.PJ_WIP_Acct, " + acct.getPJ_Asset_Acct() + ")"
				+ ", Updated=SysDate, UpdatedBy=0 "
				+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
				+ " AND EXISTS (SELECT * FROM C_Project_Acct x "
					+ "WHERE x.C_Project_ID=a.C_Project_ID)";
		...
		{
			sql = "UPDATE C_Tax_Acct a "
				+ "SET T_Due_Acct= COALESCE(a.T_Due_Acct, " + acct.getT_Due_Acct() + ")"
				+ ", T_Liability_Acct= COALESCE(a.T_Liability_Acct, " + acct.getT_Liability_Acct() + ")"
				+ ", T_Credit_Acct= COALESCE(a.T_Credit_Acct, " + acct.getT_Credit_Acct() + ")"
				+ ", T_Receivables_Acct= COALESCE(a.T_Receivables_Acct, " + acct.getT_Receivables_Acct() + ")"
				+ ", T_Expense_Acct= COALESCE(a.T_Expense_Acct, " + acct.getT_Expense_Acct() + ")"
				+ ", Updated=SysDate, UpdatedBy=0 "
				+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
				+ " AND EXISTS (SELECT * FROM C_Tax_Acct x "
					+ "WHERE x.C_Tax_ID=a.C_Tax_ID)";
		...
		{
			sql = "UPDATE C_BankAccount_Acct a "
				+ "SET B_InTransit_Acct= COALESCE(a.B_InTransit_Acct, " + acct.getB_InTransit_Acct() + ")"
				+ ", B_Asset_Acct= COALESCE(a.B_Asset_Acct, " + acct.getB_Asset_Acct() + ")"
				+ ", B_Expense_Acct= COALESCE(a.B_Expense_Acct, " + acct.getB_Expense_Acct() + ")"
				+ ", B_InterestRev_Acct= COALESCE(a.B_InterestRev_Acct, " + acct.getB_InterestRev_Acct() + ")"
				+ ", B_InterestExp_Acct= COALESCE(a.B_InterestExp_Acct, " + acct.getB_InterestExp_Acct() + ")"
				+ ", B_Unidentified_Acct= COALESCE(a.B_Unidentified_Acct, " + acct.getB_Unidentified_Acct() + ")"
				+ ", B_UnallocatedCash_Acct= COALESCE(a.B_UnallocatedCash_Acct, " + acct.getB_UnallocatedCash_Acct() + ")"
				+ ", B_PaymentSelect_Acct= COALESCE(a.B_PaymentSelect_Acct, " + acct.getB_PaymentSelect_Acct() + ")"
				+ ", B_SettlementGain_Acct= COALESCE(a.B_SettlementGain_Acct, " + acct.getB_SettlementGain_Acct() + ")"
				+ ", B_SettlementLoss_Acct= COALESCE(a.B_SettlementLoss_Acct, " + acct.getB_SettlementLoss_Acct() + ")"
				+ ", B_RevaluationGain_Acct= COALESCE(a.B_RevaluationGain_Acct, " + acct.getB_RevaluationGain_Acct() + ")"
				+ ", B_RevaluationLoss_Acct= COALESCE(a.B_RevaluationLoss_Acct, " + acct.getB_RevaluationLoss_Acct() + ")"
				+ ", Updated=SysDate, UpdatedBy=0 "
				+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
				+ " AND EXISTS (SELECT * FROM C_BankAccount_Acct x "
					+ "WHERE x.C_BankAccount_ID=a.C_BankAccount_ID)";
		...
		{
			sql = "UPDATE C_Withholding_Acct a "
				+ "SET Withholding_Acct= COALESCE(a.Withholding_Acct, " + acct.getWithholding_Acct() + ")"
				+ ", Updated=SysDate, UpdatedBy=0 "
				+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID 
				+ " AND EXISTS (SELECT * FROM C_Withholding_Acct x "
					+ "WHERE x.C_Withholding_ID=a.C_Withholding_ID)";
		...
		{
			sql = "UPDATE C_Charge_Acct a "
				+ "SET Ch_Expense_Acct= COALESCE(a.Ch_Expense_Acct, " + acct.getCh_Expense_Acct() + ")"
				+ ", Ch_Revenue_Acct=" + acct.getCh_Revenue_Acct()
				+ ", Updated=SysDate, UpdatedBy=0 "
				+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
				+ " AND EXISTS (SELECT * FROM C_Charge_Acct x "
		...
		{
			sql = "UPDATE C_Cashbook_Acct a "
				+ "SET CB_Asset_Acct= COALESCE(a.CB_Asset_Acct, " + acct.getCB_Asset_Acct() + ")"
				+ ", CB_Differences_Acct= COALESCE(a.CB_Differences_Acct," + acct.getCB_Differences_Acct() + ")"
				+ ", CB_CashTransfer_Acct= COALESCE(a.CB_CashTransfer_Acct," + acct.getCB_CashTransfer_Acct() + ")"
				+ ", CB_Expense_Acct= COALESCE(a.CB_Expense_Acct," + acct.getCB_Expense_Acct() + ")"
				+ ", CB_Receipt_Acct= COALESCE(a.CB_Receipt_Acct," + acct.getCB_Receipt_Acct() + ")"
				+ ", Updated=SysDate, UpdatedBy=0 "
				+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
				+ " AND EXISTS (SELECT * FROM C_Cashbook_Acct x "
					+ "WHERE x.C_Cashbook_ID=a.C_Cashbook_ID)";
		...
		if (!(se==null) && se.checkLicense())
		{
			...
			if (p_CopyOverwriteAcct)
			{
				sql = "UPDATE M_WorkOrderClass_Acct a "
					...
					+ ", WO_MaterialOverhd_Acct=" + acct.getWO_MaterialOverhd_Acct()
					+ ", WO_Resource_Acct=" + acct.getWO_Resource_Acct()
					+ ", WO_MaterialVariance_Acct=" + acct.getWO_MaterialVariance_Acct()
					+ ", WO_MaterialOverhdVariance_Acct=" + acct.getWO_MaterialOverhdVariance_Acct()
					+ ", WO_ResourceVariance_Acct=" + acct.getWO_ResourceVariance_Acct()
					+ ", WO_OverhdVariance_Acct="  + acct.getWO_OverhdVariance_Acct()
					+ ", WO_Scrap_Acct=" + acct.getWO_Scrap_Acct()
					+ ", Updated=SysDate, UpdatedBy=0 "
					+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
			...
			{
				sql = "UPDATE M_WorkOrderClass_Acct a "
					+ "SET WO_Material_Acct= COALESCE(a.WO_Material_Acct, " + acct.getWO_Material_Acct() + ")"
					+ ", WO_MaterialOverhd_Acct= COALESCE(a.WO_MaterialOverhd_Acct, " + acct.getWO_MaterialOverhd_Acct() + ")"
					+ ", WO_Resource_Acct= COALESCE(a.WO_Resource_Acct, " + acct.getWO_Resource_Acct() + ")"
					+ ", WO_MaterialVariance_Acct= COALESCE(a.WO_MaterialVariance_Acct, " + acct.getWO_MaterialVariance_Acct() + ")"
					+ ", WO_MaterialOverhdVariance_Acct= COALESCE(a.WO_MaterialOverhdVariance_Acct, " + acct.getWO_MaterialOverhdVariance_Acct() + ")"
					+ ", WO_ResourceVariance_Acct= COALESCE(a.WO_ResourceVariance_Acct, " + acct.getWO_ResourceVariance_Acct() + ")"
					+ ", WO_OverhdVariance_Acct= COALESCE(a.WO_OverhdVariance_Acct, "  + acct.getWO_OverhdVariance_Acct() + ")"
					+ ", WO_Scrap_Acct= COALESCE(a.WO_Scrap_Acct, " + acct.getWO_Scrap_Acct() + ")"
					+ ", Updated=SysDate, UpdatedBy=0 "
					+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
					+ " AND EXISTS (SELECT * FROM M_WorkOrderClass_Acct x "
					+ "WHERE x.M_WorkOrderClass_ID=a.M_WorkOrderClass_ID)";
			...
			if (p_CopyOverwriteAcct)
			{
				sql = "UPDATE M_WorkCenter_Acct a "
					+ "SET WC_Overhead_Acct=" + acct.getWC_Overhead_Acct()
					+ ", Updated=SysDate, UpdatedBy=0 "
					+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
			...
			{
				sql = "UPDATE M_WorkCenter_Acct a "
					+ "SET WC_Overhead_Acct= COALESCE(a.WC_Overhead_Acct, " + acct.getWC_Overhead_Acct() + ")"
					+ ", Updated=SysDate, UpdatedBy=0 "
					+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
					+ " AND EXISTS (SELECT * FROM M_WorkCenter_Acct x "
					+ "WHERE x.M_WorkCenter_ID=a.M_WorkCenter_ID)";
			...
			if (p_CopyOverwriteAcct)
			{
				sql = "UPDATE M_WorkCenterCost a "
					+ "SET Overhead_Absorption_Acct=" + acct.getOverhead_Absorption_Acct()
					+ ", Updated=sysdate, UpdatedBy=0 "
					+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
			...
			{
				sql = "UPDATE M_WorkCenterCost a "
					+ "SET Overhead_Absorption_Acct= COALESCE(a.Overhead_Absorption_Acct, " + acct.getOverhead_Absorption_Acct() + ")"
					+ ", Updated=sysdate, UpdatedBy=0 "
					+ "WHERE a.C_AcctSchema_ID=" + p_C_AcctSchema_ID
					+ " AND EXISTS (SELECT * FROM M_WorkCenterCost x "
					+ "WHERE x.M_WorkCenter_ID=a.M_WorkCenter_ID"
