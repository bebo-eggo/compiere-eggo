 ...
 *
 *  @author 	Jorg Janke
 *  @version 	$Id: MCountry.java 8753 2010-05-12 17:34:49Z nnayak $
 */
	...
	private static void loadAllCountries (Ctx ctx)
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				c.setName(c.get_Translation("Name", lang.getAD_Language())!=null?c.get_Translation("Name", lang.getAD_Language()):c.getName());
