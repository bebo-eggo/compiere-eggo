...
/** Generated Model for Z_S_S_Famille
 *  @author Jorg Janke (generated) 
 *  @version Release 3.6.1 - $Id: GenerateModel.java 8757 2010-05-12 21:32:32Z nnayak $ */
public class X_Z_S_S_Famille extends POExtended implements POInterface
{
    /** Standard Constructor
    @param ctx context
    @param Z_S_S_Famille_ID id
    @param trx transaction
    */
    public X_Z_S_S_Famille (Ctx ctx, int Z_S_S_Famille_ID, Trx trx)
    {
        super (ctx, Z_S_S_Famille_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (Z_S_S_Famille_ID == 0)
        {
            setName (null);
            setValue (null);
            setZ_S_Famille_ID (0);
    ...
    @param trx transaction
    */
    public X_Z_S_S_Famille (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27623880418789L;
    /** Last Updated Timestamp 2012-07-08 14:45:02.0 */
    public static final long updatedMS = 1341755102000L;
    /** AD_Table_ID=1000852 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("Z_S_S_Famille");
        
    }
    ;
    
    /** TableName=Z_S_S_Famille */
    public static final String Table_Name="Z_S_S_Famille";
