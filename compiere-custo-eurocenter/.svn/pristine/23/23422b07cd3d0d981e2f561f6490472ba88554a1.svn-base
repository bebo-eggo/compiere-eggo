 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: Language.java 8244 2009-12-04 23:25:29Z freyes $
 */
...
*/			
	...
	public static Language getLanguage (String langInfo)
	{
		...
		if((System.getProperty("user.language") + "_" + System.getProperty("user.country")).equals(lang))
			return s_loginLanguage;
	...
	{
		//ZCOM #24402 return s_languages[0].getAD_Language();
		return s_languages[1].getAD_Language(); //ZCOM #24402
	}   //  getBase
	...
	public static String[] getNames()
	{
		...
		for (int i = 0; i < s_languages.length; i++)
			if ("US,FR,NL".contains(s_languages[i].getLocale().getCountry()))
