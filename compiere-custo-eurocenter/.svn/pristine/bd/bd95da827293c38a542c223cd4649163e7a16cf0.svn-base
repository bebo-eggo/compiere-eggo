...
public class MSession extends X_AD_Session
{
	...
	public static MSession get (Ctx ctx)
	{
		...
		if (session == null)
			s_log.info("No Session");
		/*ZCOM VHA On s'en fiche non ?
	...
	public void logout(String activity)
	{
		...
		s_log.log(Level.WARNING, "logout Set Processed true, activty" + activity + " " + this.toString());
		setProcessed(true);
		save();
    ...
    {
		s_log.log(Level.WARNING, "setProcessed : " + Processed + ", " + this.toString());
