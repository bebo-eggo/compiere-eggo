...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Name = 'Accompte',PO_PrintName = '',Help = '',PrintName = 'Accompte',PO_Name = '',PO_Description = '',PO_Help = '' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='IsAccompte') and ad_language = 'nl_NL';
...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Name = 'Accompte',PO_PrintName = '',Help = '',PrintName = 'Accompte',PO_Name = '',PO_Description = '',PO_Help = '' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='IsAccompte') and ad_language = 'fr_FR';
...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Name = 'Accompte Reprise',PO_PrintName = '',Help = '',PrintName = 'Accompte Reprise',PO_Name = '',PO_Description = '',PO_Help = '' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='IsAccompteReprise') and ad_language = 'nl_NL';
...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Name = 'Accompte Reprise',PO_PrintName = '',Help = '',PrintName = 'Accompte Reprise',PO_Name = '',PO_Description = '',PO_Help = '' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='IsAccompteReprise') and ad_language = 'fr_FR';
...
update AD_Column set Updated = sysdate, UpdatedBy = 0, ad_element_id = (select AD_Element_ID from AD_Element where ColumnName = 'IsEggo'), ad_process_id = (select AD_Process_ID from AD_Process where Value = ''), ad_reference_id = (select AD_Reference_ID from AD_Reference where Name = 'Yes-No'), ad_reference_value_id = (select AD_Reference_ID from AD_Reference where Name = ''), ad_table_id = (select AD_Table_ID from AD_Table where TableName = 'M_PriceList'), ad_val_rule_id = (select AD_Val_Rule_ID from AD_Val_Rule where Name = ''), callout = '', defaultvalue = '', description = '', entitytype = 'ME01', fieldlength = 1, help = '', name = 'Eggo', readonlylogic = '', seqno = 0, valuemax = '', valuemin = '', version = 0, vformat = '', isactive = 'Y', isalwaysupdateable = 'N', isencrypted = 'N', isidentifier = 'N', iskey = 'N', ismandatory = 'Y', isparent = 'N', isselectioncolumn = 'N', istranslated = 'N', isupdateable = 'Y', columnsql = '', constrainttype = '', ismandatoryui = 'Y', MANDATORYLOGIC = '', TABLEUID = 0, ISCALLOUT = 'N', ISRECURSIVEFK = 'N', ISSUMMARYCOLUMN = 'N', SELECTIONSEQNO = 0, SUMMARYSEQNO = 0 
