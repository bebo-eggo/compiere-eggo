...
public class X_C_DocType extends POExtended implements POInterface
{
    ...
    */
    ...
    public void setZ_IsStorageEvent(boolean Z_IsStorageEvent)
    {
        set_Value ("Z_IsStorageEvent", Boolean.valueOf(Z_IsStorageEvent));
        
    }
    
    public boolean isZ_IsStorageEvent() 
    {
        return get_ValueAsBoolean("Z_IsStorageEvent");
