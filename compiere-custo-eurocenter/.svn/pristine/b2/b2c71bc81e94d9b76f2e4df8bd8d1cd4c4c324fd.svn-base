...
public class X_C_InvoiceLine extends POExtended implements POInterface
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27549678687789L;
    /** Last Updated Timestamp 2010-03-02 19:09:31.0 */
    public static final long updatedMS = 1267553371000L;
    /** AD_Table_ID=333 */
    ...
    /** Set Price Recupel.
    @param PriceRecupel Price Recupel  */
    public void setPriceRecupel (java.math.BigDecimal PriceRecupel)
    {
        set_Value ("PriceRecupel", PriceRecupel);
        
    }
    
    /** Get PriceRecupel.
    @return PriceRecupel  */
    public java.math.BigDecimal getPriceRecupel() 
    {
        return get_ValueAsBigDecimal("PriceRecupel");
        
    }
    
    /** Set Line Recupel Amt
    @param LineRecupelAmt   */
    public void setLineRecupelAmt (java.math.BigDecimal LineRecupelAmt)
    {
        set_Value ("LineRecupelAmt", LineRecupelAmt);
        
    }
    
    /** Get Line Recupel Amt
    @return LineRecupelAmt - the price based on the selected/base UoM */
    public java.math.BigDecimal getLineRecupelAmt() 
    {
        return get_ValueAsBigDecimal("LineRecupelAmt");
