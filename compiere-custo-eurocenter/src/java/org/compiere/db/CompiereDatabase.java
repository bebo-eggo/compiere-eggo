 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: CompiereDatabase.java 10596 2012-11-23 22:50:33Z jorg.janke $
 */
public interface CompiereDatabase
{
	...
	/**
	 * 	Get JDBC Schema. For Oracle it is the Schema Name, 
	 * so consider using DatabaseMetaData.getUserName()
	 *	@return schema
	 */
