...
import org.compiere.model.X_M_TaskList;
...
//			}
		...
		String newOptions[] = (String[]) GenericCall.genericCall("wf",table.getTableName(),"dynInit",args);
		if (newOptions != null){
			options = new String[newOptions.length];;
			index = 0;
			for (int k = 0; k < newOptions.length; k++) {
				String option = newOptions[k];
				if (option != null) options[index++] = option;
			}
		}
		/*ZCOM182** END */
