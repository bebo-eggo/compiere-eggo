...
public class PeriodStatus extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		//ZCOM vérifier si n'existe pas dans Z_ExclureClosePeriod
		if (X_C_PeriodControl.PERIODACTION_ClosePeriod.equals(p_PeriodAction) || X_C_PeriodControl.PERIODACTION_PermanentlyClosePeriod.equals(p_PeriodAction))
			sql.append(" AND NOT EXISTS(Select 1 from Z_EXCLUDECLOSEPERIOD where Z_EXCLUDECLOSEPERIOD.IsActive = 'Y' "
				+ "and Z_EXCLUDECLOSEPERIOD.AD_Client_ID = C_PeriodControl.AD_Client_ID and C_PeriodControl.DOCBASETYPE = Z_EXCLUDECLOSEPERIOD.DOCBASETYPE) ");
