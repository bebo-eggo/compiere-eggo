...
public class X_M_AttributeInstance extends POExtended implements POInterface
{
    ...
    */
    ...
    {//Si type liste => " "
    	MAttribute ma = new MAttribute(getCtx(),getM_Attribute_ID(),null);
    	if(ma.getAttributeValueType().equals(MAttribute.ATTRIBUTEVALUETYPE_List))
    		set_Value ("Value", Value==null?" ":Value);
    	else
