...
public class MRequisition extends X_M_Requisition implements DocAction
{
    ...
    public void setDatePose (Timestamp DatePose)
    {
        if (DatePose == null) throw new IllegalArgumentException ("DatePose is mandatory.");
        set_Value ("DatePose", DatePose);
        
    }
    
    /** Get DatePose.
    @return DatePose */
    public Timestamp getDatePose() 
    {
        return (Timestamp)get_Value("DatePose");
