 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MUserQuery.java 8756 2010-05-12 21:21:27Z nnayak $
 */
public class MUserQuery extends X_AD_UserQuery
{
	...
	{   //Anomalie #61280 : vues en double : add *distinct*
		String sql = "SELECT distinct Name FROM AD_UserQuery "
