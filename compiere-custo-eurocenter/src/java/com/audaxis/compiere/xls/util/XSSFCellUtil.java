...
public final class XSSFCellUtil
{
     ...
     */
    public static void setCellStyleProperty( XSSFCell cell, XSSFWorkbook workbook, String propertyName, Object propertyValue )
    {
     ...
     * @see #setFormatProperties(XSSFCellStyle, Map)
     */
    private static Map getFormatProperties(XSSFCellStyle style) {
     ...
     * @see #getFormatProperties(XSSFCellStyle)
     */
    private static void setFormatProperties(
            XSSFCellStyle style, XSSFWorkbook workbook, Map properties) {
