...
update AD_Process_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'CopyLocationCuisine',Description = '',Help = '' where AD_Process_ID in (select AD_Process_ID from AD_Process where Value='CopyLocationCuisine') and ad_language = 'nl_NL';
...
update AD_Process_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'CopyLocationCuisine',Description = '',Help = '' where AD_Process_ID in (select AD_Process_ID from AD_Process where Value='CopyLocationCuisine') and ad_language = 'fr_FR';
...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Name = 'Copie adresse Cuisine',PrintName = 'Copie adresse Cuisine',PO_PrintName = '',PO_Name = '',PO_Description = '',Help = '',PO_Help = '' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='CopyLocationCuisine') and ad_language = 'nl_NL';
...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Name = 'Copie adresse Cuisine',PrintName = 'Copie adresse Cuisine',PO_PrintName = '',PO_Name = '',PO_Description = '',Help = '',PO_Help = '' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='CopyLocationCuisine') and ad_language = 'fr_FR';
...
update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Copie adresse Cuisine',Description = '',Help = '' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'CopyLocationCuisine' and ad_table_id in (select ad_table_id from ad_table where tablename = 'C_BPartner_Location')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Location_222' and ad_window_id in (select ad_window_id from ad_window where value = 'Business Partner_123'))) and ad_language = 'nl_NL';
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Location_222_1000120' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Business Partner_(Eggo)')), name = 'Copy Location Cuisine', description = '', displaylength = 1, displaylogic = '@IsEggo@=''N'' &'||' @IsBillTo@=''N'' &'||' @IsShipTo@=''Y''', entitytype = 'ME10', help = '', obscuretype = '', seqno = 100, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'CopyLocationCuisine' and ad_table_id in (select ad_table_id from ad_table where tablename = 'C_BPartner_Location'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Location_222_1000120' and ad_window_id in (select ad_window_id from ad_window where value = 'Business Partner_(Eggo)'));
...
update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Copy Location Cuisine',Description = '',Help = '' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'CopyLocationCuisine' and ad_table_id in (select ad_table_id from ad_table where tablename = 'C_BPartner_Location')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Location_222_1000120' and ad_window_id in (select ad_window_id from ad_window where value = 'Business Partner_(Eggo)'))) and ad_language = 'nl_NL';

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Name,Description,Help) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'CopyLocationCuisine' and ad_table_id in (select ad_table_id from ad_table where tablename = 'C_BPartner_Location')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Location_222_1000120' and ad_window_id in (select ad_window_id from ad_window where value = 'Business Partner_(Eggo)'))), 'fr_FR', 'Y', 'Copy Location Cuisine','',''
 from dual  
...
update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Cuisine',Description = '',Help = '' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsEggo' and ad_table_id in (select ad_table_id from ad_table where tablename = 'C_BPartner_Location')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Location_222_1000120' and ad_window_id in (select ad_window_id from ad_window where value = 'Business Partner_(Eggo)'))) and ad_language = 'nl_NL';
