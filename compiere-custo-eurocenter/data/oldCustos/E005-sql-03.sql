...
insert into AD_Window_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Window_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Window_ID from AD_Window where Value='Transactions Messages'), 'fr_FR', 'Y', 'Transactions Messages','','Messages des transactions POS'
 from dual  
...
update AD_Window_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Transactions Messages',Help = '',Name = 'Messages des transactions POS' where AD_Window_ID in (select AD_Window_ID from AD_Window where Value='Transactions Messages') and ad_language = 'fr_FR';
...
insert into AD_Window_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Window_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Window_ID from AD_Window where Value='Validation des Messages'), 'fr_FR', 'Y', 'Validation des Messages','','Validation des Messages POS'
 from dual  
...
update AD_Window_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Validation des Messages',Help = '',Name = 'Validation des Messages POS' where AD_Window_ID in (select AD_Window_ID from AD_Window where Value='Validation des Messages') and ad_language = 'fr_FR';
...
0
 from dual  
where not exists (select 1 from AD_Column where ColumnName = 'Z_S_Famille_ID'  and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'));

update AD_Column set Updated = sysdate, UpdatedBy = 0, ad_element_id = (select AD_Element_ID from AD_Element where ColumnName = 'Z_S_Famille_ID'), ad_process_id = (select AD_Process_ID from AD_Process where Value = ''), ad_reference_id = (select AD_Reference_ID from AD_Reference where Name = 'Table Direct'), ad_reference_value_id = (select AD_Reference_ID from AD_Reference where Name = ''), ad_table_id = (select AD_Table_ID from AD_Table where TableName = 'Z_TransactionMsg'), ad_val_rule_id = (select AD_Val_Rule_ID from AD_Val_Rule where Name = ''), callout = '', defaultvalue = '', description = 'Sous familles', entitytype = 'E005', fieldlength = 22, help = '', name = 'Sous Famille', readonlylogic = '', seqno = 0, valuemax = '', valuemin = '', version = 0, vformat = '', isactive = 'Y', isalwaysupdateable = 'N', isencrypted = 'N', isidentifier = 'N', iskey = 'N', ismandatory = 'N', isparent = 'N', isselectioncolumn = 'N', istranslated = 'N', isupdateable = 'Y', columnsql = '', constrainttype = '', ismandatoryui = 'N', MANDATORYLOGIC = '', TABLEUID = 0, ISCALLOUT = 'N', ISRECURSIVEFK = 'N', ISSUMMARYCOLUMN = 'N', SELECTIONSEQNO = 0, SUMMARYSEQNO = 0 
where ColumnName = 'Z_S_Famille_ID'  and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg');

insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')), 'nl_BE', 'Y', 'Sous Famille'
 from dual  
where not exists (select 1 from AD_Column_Trl where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'nl_BE');

update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Sous Famille' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'nl_BE';

insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')), 'fr_FR', 'Y', 'Sous Famille'
 from dual  
where not exists (select 1 from AD_Column_Trl where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'fr_FR');

update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Sous Famille' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'fr_FR';
...
0
 from dual  
where not exists (select 1 from AD_Column where ColumnName = 'Z_S_S_S_Famille_ID'  and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'));

update AD_Column set Updated = sysdate, UpdatedBy = 0, ad_element_id = (select AD_Element_ID from AD_Element where ColumnName = 'Z_S_S_S_Famille_ID'), ad_process_id = (select AD_Process_ID from AD_Process where Value = ''), ad_reference_id = (select AD_Reference_ID from AD_Reference where Name = 'Table Direct'), ad_reference_value_id = (select AD_Reference_ID from AD_Reference where Name = ''), ad_table_id = (select AD_Table_ID from AD_Table where TableName = 'Z_TransactionMsg'), ad_val_rule_id = (select AD_Val_Rule_ID from AD_Val_Rule where Name = ''), callout = '', defaultvalue = '', description = '', entitytype = 'E005', fieldlength = 22, help = '', name = 'Sous sous sous famille', readonlylogic = '', seqno = 0, valuemax = '', valuemin = '', version = 0, vformat = '', isactive = 'Y', isalwaysupdateable = 'N', isencrypted = 'N', isidentifier = 'N', iskey = 'N', ismandatory = 'N', isparent = 'N', isselectioncolumn = 'N', istranslated = 'N', isupdateable = 'Y', columnsql = '', constrainttype = '', ismandatoryui = 'N', MANDATORYLOGIC = '', TABLEUID = 0, ISCALLOUT = 'N', ISRECURSIVEFK = 'N', ISSUMMARYCOLUMN = 'N', SELECTIONSEQNO = 0, SUMMARYSEQNO = 0 
where ColumnName = 'Z_S_S_S_Famille_ID'  and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg');

insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')), 'nl_BE', 'Y', 'Sous sous sous famille'
 from dual  
where not exists (select 1 from AD_Column_Trl where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'nl_BE');

update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Sous sous sous famille' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'nl_BE';

insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')), 'fr_FR', 'Y', 'Sous sous sous famille'
 from dual  
where not exists (select 1 from AD_Column_Trl where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'fr_FR');

update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Sous sous sous famille' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'fr_FR';
...
0
 from dual  
where not exists (select 1 from AD_Column where ColumnName = 'Z_S_S_Famille_ID'  and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'));

update AD_Column set Updated = sysdate, UpdatedBy = 0, ad_element_id = (select AD_Element_ID from AD_Element where ColumnName = 'Z_S_S_Famille_ID'), ad_process_id = (select AD_Process_ID from AD_Process where Value = ''), ad_reference_id = (select AD_Reference_ID from AD_Reference where Name = 'Table Direct'), ad_reference_value_id = (select AD_Reference_ID from AD_Reference where Name = ''), ad_table_id = (select AD_Table_ID from AD_Table where TableName = 'Z_TransactionMsg'), ad_val_rule_id = (select AD_Val_Rule_ID from AD_Val_Rule where Name = ''), callout = '', defaultvalue = '', description = '', entitytype = 'E005', fieldlength = 22, help = '', name = 'Sous sous famille', readonlylogic = '', seqno = 0, valuemax = '', valuemin = '', version = 0, vformat = '', isactive = 'Y', isalwaysupdateable = 'N', isencrypted = 'N', isidentifier = 'N', iskey = 'N', ismandatory = 'N', isparent = 'N', isselectioncolumn = 'N', istranslated = 'N', isupdateable = 'Y', columnsql = '', constrainttype = '', ismandatoryui = 'N', MANDATORYLOGIC = '', TABLEUID = 0, ISCALLOUT = 'N', ISRECURSIVEFK = 'N', ISSUMMARYCOLUMN = 'N', SELECTIONSEQNO = 0, SUMMARYSEQNO = 0 
where ColumnName = 'Z_S_S_Famille_ID'  and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg');

insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')), 'nl_BE', 'Y', 'Sous sous famille'
 from dual  
where not exists (select 1 from AD_Column_Trl where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'nl_BE');

update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Sous sous famille' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'nl_BE';

insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')), 'fr_FR', 'Y', 'Sous sous famille'
 from dual  
where not exists (select 1 from AD_Column_Trl where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'fr_FR');

update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Sous sous famille' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_language = 'fr_FR';
...
update AD_Column set Updated = sysdate, UpdatedBy = 0, ad_element_id = (select AD_Element_ID from AD_Element where ColumnName = 'Z_PosWfAction_ID'), ad_process_id = (select AD_Process_ID from AD_Process where Value = ''), ad_reference_id = (select AD_Reference_ID from AD_Reference where Name = 'Table Direct'), ad_reference_value_id = (select AD_Reference_ID from AD_Reference where Name = ''), ad_table_id = (select AD_Table_ID from AD_Table where TableName = 'Z_TransactionMsg'), ad_val_rule_id = (select AD_Val_Rule_ID from AD_Val_Rule where Name = ''), callout = '', defaultvalue = '', description = '', entitytype = 'E005', fieldlength = 22, help = '', name = 'Z_PosWfAction_ID', readonlylogic = '', seqno = 0, valuemax = '', valuemin = '', version = 0, vformat = '', isactive = 'Y', isalwaysupdateable = 'N', isencrypted = 'N', isidentifier = 'N', iskey = 'N', ismandatory = 'Y', isparent = 'N', isselectioncolumn = 'Y', istranslated = 'N', isupdateable = 'Y', columnsql = '', constrainttype = '', ismandatoryui = 'Y', MANDATORYLOGIC = '', TABLEUID = 0, ISCALLOUT = 'N', ISRECURSIVEFK = 'N', ISSUMMARYCOLUMN = 'N', SELECTIONSEQNO = 20, SUMMARYSEQNO = 0 
...
insert into AD_Tab_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Tab_ID,AD_Language, IsTranslated,CommitWarning,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Tab_ID from AD_Tab where Value='Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages')), 'fr_FR', 'Y', '','Transactions Messages','','Messages des transactions POS'
 from dual  
...
update AD_Tab_Trl set Updated = sysdate, UpdatedBy = 0,CommitWarning = '',Description = 'Transactions Messages',Help = '',Name = 'Messages des transactions POS' where AD_Tab_ID in (select AD_Tab_ID from AD_Tab where Value='Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages')) and ad_language = 'fr_FR';
...
update AD_Tab set Updated = sysdate, UpdatedBy = 0, name = 'Validation des Messages', ad_columnsortorder_id = (select AD_Column_ID from AD_Column where ColumnName = '' and AD_Table_ID in (select AD_Table_ID from AD_Table where TableName = 'Z_TransactionMsg')), ad_columnsortyesno_id = (select AD_Column_ID from AD_Column where ColumnName = '' and AD_Table_ID in (select AD_Table_ID from AD_Table where TableName = 'Z_TransactionMsg')), ad_column_id = (select AD_Column_ID from AD_Column where ColumnName = '' and AD_Table_ID in (select AD_Table_ID from AD_Table where TableName = 'Z_TransactionMsg')), ad_image_id = (select AD_Image_ID from AD_Image where Name = ''), ad_process_id = (select AD_Process_ID from AD_Process where Value = ''), ad_table_id = (select AD_Table_ID from AD_Table where TableName = 'Z_TransactionMsg'), ad_window_id = (select AD_Window_ID from AD_Window where Value = 'Validation des Messages'), commitwarning = '', description = '', entitytype = 'E005', help = '', importfields = 'N', included_tab_id = (select AD_Tab_ID from AD_Tab where Value = '' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Validation des Messages')), orderbyclause = '', seqno = 10, tablevel = 0, whereclause = 'z_transactionmsg_id in  (select z_transactionmsg_id from z_transactionmsg tr where   (    (tr.ad_orgtrx_id =  @#AD_Org_ID@ AND tr.ad_org_id = tr.ad_orgtrx_id        AND EXISTS (select 1 from z_posactionActivity act where act.z_poswfaction_id = tr.z_poswfaction_id and act.z_poswfactivity_id = tr.z_poswfactivity_id and act.isvalidatedbyorgfrom = ''Y''and act.ad_role_id = @#AD_Role_ID@)     )       or                                         (tr.ad_orgto_id = @#AD_Org_ID@ AND tr.ad_org_id = tr.ad_orgto_id        AND EXISTS (select 1 from z_posActionActivity act where act.z_poswfaction_id = tr.z_poswfaction_id and act.z_poswfactivity_id = tr.z_poswfactivity_id and act.isvalidatedbyorgto = ''Y'' and act.ad_role_id = @#AD_Role_ID@ )     )       or  EXISTS (select 1 from z_posActionActivity act where act.z_poswfaction_id = tr.z_poswfaction_id and act.z_poswfactivity_id = tr.z_poswfactivity_id and act.isvalidatedbyorgfrom = ''Y''  and act.isvalidatedbyorgto = ''Y'' and act.ad_role_id = @#AD_Role_ID@ )  )  and ( tr.isvalidatedrequest = ''N'' and tr.iscancelrequest = ''N'' )) ', isactive = 'Y', hastree = 'N', isinfotab = 'N', isreadonly = 'N', issinglerow = 'N', issorttab = 'N', istranslationtab = 'N', DISPLAYLOGIC = '', ISADVANCEDTAB = 'N', ISINSERTRECORD = 'N', READONLYLOGIC = '', AD_CTXAREA_ID = (select AD_CtxArea_ID from AD_CtxArea where Name = ''), ISDISPLAYED = 'Y', REFERENCED_TAB_ID = (select AD_Tab_ID from AD_Tab where Value = '') 
...
insert into AD_Tab_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Tab_ID,AD_Language, IsTranslated,CommitWarning,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Tab_ID from AD_Tab where Value='Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages')), 'nl_BE', 'Y', '','','','Validation des Messages POS'
 from dual  
...
update AD_Tab_Trl set Updated = sysdate, UpdatedBy = 0,CommitWarning = '',Description = '',Help = '',Name = 'Validation des Messages POS' where AD_Tab_ID in (select AD_Tab_ID from AD_Tab where Value='Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages')) and ad_language = 'nl_BE';

insert into AD_Tab_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Tab_ID,AD_Language, IsTranslated,CommitWarning,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Tab_ID from AD_Tab where Value='Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages')), 'fr_FR', 'Y', '','','','Validation des Messages POS'
 from dual  
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_PosWfAction_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))), 'nl_BE', 'Y', '','','Action'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_PosWfAction_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))) and ad_language = 'nl_BE');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Help = '',Name = 'Action' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_PosWfAction_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))) and ad_language = 'nl_BE';

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_PosWfAction_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))), 'fr_FR', 'Y', '','','Action'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_PosWfAction_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = ''),
(select AD_Tab_ID from AD_Tab where Value = 'Validation des Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Validation des Messages')),
'Sous Famille',
'Sous familles',
22,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Validation des Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Validation des Messages')), name = 'Sous Famille', description = 'Sous familles', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 0, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'N', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = ''),
(select AD_Tab_ID from AD_Tab where Value = 'Validation des Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Validation des Messages')),
'Sous sous famille',
'',
22,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Validation des Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Validation des Messages')), name = 'Sous sous famille', description = '', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 0, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'N', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = ''),
(select AD_Tab_ID from AD_Tab where Value = 'Validation des Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Validation des Messages')),
'Sous sous sous famille',
'',
22,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Validation des Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Validation des Messages')), name = 'Sous sous sous famille', description = '', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 0, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'N', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'ErrorMsg' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = ''),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Error Message',
'',
60,
...
0
 from dual  
where not exists (select 1 from AD_Field where ad_column_id = (select ad_column_id from ad_column where columnname = 'ErrorMsg' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages')));

update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Error Message', description = '', displaylength = 60, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 320, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'ErrorMsg' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ErrorMsg' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','Error Message'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ErrorMsg' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Help = '',Name = 'Error Message' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ErrorMsg' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE';

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ErrorMsg' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Message erreur'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ErrorMsg' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Help = '',Name = 'Message erreur' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ErrorMsg' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_PosWfAction_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Action'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_PosWfAction_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ActionComment' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Commentaire POS'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ActionComment' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Help = '',Name = 'Commentaire POS' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ActionComment' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ActionDate' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Date'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ActionDate' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Validation des Messages_1000328' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Validation Création d''Article')), name = 'Sous sous sous famille', description = '', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 110, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'Y', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages_1000328' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation Création d''Article'));
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'POReceiptNO' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Réception achat'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'POReceiptNO' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Help = '',Name = 'Réception achat' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'POReceiptNO' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ProcessComment' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Commentaire'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ProcessComment' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Fournisseur' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Fournisseur',
'',
60,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Fournisseur', description = '', displaylength = 60, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 280, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Fournisseur' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Fournisseur' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','Fournisseur'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Fournisseur' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Fournisseur' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Fournisseur'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Fournisseur' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'IsCancelRequest', description = '', displaylength = 1, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 50, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'Y', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'IsCancelRequest' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsCancelRequest' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','IsCancelRequest'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsCancelRequest' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsCancelRequest' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Refuser'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsCancelRequest' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'IsValidatedRequest', description = '', displaylength = 1, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 40, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'IsValidatedRequest' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsValidatedRequest' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','IsValidatedRequest'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsValidatedRequest' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsValidatedRequest' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Valider'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsValidatedRequest' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Y_Marque_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Marque',
'',
22,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Marque', description = '', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 290, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Y_Marque_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'M_Product_Category_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Product Category',
'Category of a Product',
22,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Product Category', description = 'Category of a Product', displaylength = 22, displaylogic = '', entitytype = 'E005', help = 'Identifies the category which this product belongs to.  Product categories are used for pricing and selection.', obscuretype = '', seqno = 240, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'M_Product_Category_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'M_Product_Category_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', 'Category of a Product','Identifies the category which this product belongs to.  Product categories are used for pricing and selection.','Product Category'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'M_Product_Category_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'M_Product_Category_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', 'Catégorie à laquelle appartient l''article.','Catégorie à laquelle appartient l''article. La catégorie article est utilisée pour définir les prix et les coûts.','Famille'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'M_Product_Category_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Catégorie à laquelle appartient l''article.',Help = 'Catégorie à laquelle appartient l''article. La catégorie article est utilisée pour définir les prix et les coûts.',Name = 'Famille' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'M_Product_Category_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR';

insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Product_Created_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Product_Created_ID',
'',
22,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Product_Created_ID', description = '', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 210, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Product_Created_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Product_Created_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','Product_Created_ID'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Product_Created_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Product_Created_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Nouveau Produit Créé'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Product_Created_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Product_Price' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Product_Price',
'',
14,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Product_Price', description = '', displaylength = 14, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 300, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'Y', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Product_Price' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Product_Price' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','Prix'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Product_Price' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Product_Price' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Prix'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Product_Price' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Z_ProdDescription' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Z_ProdDescription',
'',
400,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Z_ProdDescription', description = '', displaylength = 400, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 230, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Z_ProdDescription' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_ProdDescription' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','Z_ProdDescription'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_ProdDescription' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_ProdDescription' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Description'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_ProdDescription' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Z_ReferenceArt' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Z_ReferenceArt',
'',
30,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Z_ReferenceArt', description = '', displaylength = 30, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 220, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Z_ReferenceArt' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_ReferenceArt' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','Z_ReferenceArt'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_ReferenceArt' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_ReferenceArt' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Réf.Article'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_ReferenceArt' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Sous Famille',
'Sous familles',
22,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Sous Famille', description = 'Sous familles', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 250, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'Y', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','Z_Sous_Famille_ID'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Sous-Famille'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Sous sous famille',
'',
22,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Sous sous famille', description = '', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 260, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','Z_Sous_S_Famille_ID'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Ss-Famille'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Sous sous sous famille',
'',
22,
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Demande Création Article'), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Sous sous sous famille', description = '', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 270, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'Y', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','Z_Sous_S_S_Famille_ID'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Sss-Famille'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_S_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ActionComment' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))), 'fr_FR', 'Y', '','','Commentaire'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ActionComment' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ActionDate' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))), 'fr_FR', 'Y', '','','Date Action'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ActionDate' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Help = '',Name = 'Date Action' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ActionDate' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_OrgTo_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))), 'fr_FR', 'Y', 'Organisation valide pour les documents inter compagnies','Identifie les organisations qui peuvent être utilisées par cette organisation au niveau des documents inter Compagnie','Organisation Cible'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_OrgTo_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Organisation valide pour les documents inter compagnies',Help = 'Identifie les organisations qui peuvent être utilisées par cette organisation au niveau des documents inter Compagnie',Name = 'Organisation Cible' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_OrgTo_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'DocumentNo' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))), 'fr_FR', 'Y', 'Numéros du document','','N° Pièce'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'DocumentNo' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Numéros du document',Help = '',Name = 'N° Pièce' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'DocumentNo' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation des Messages'))) and ad_language = 'fr_FR';
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Validation des Messages_1000328' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Validation Création d''Article')), name = 'Sous sous famille', description = '', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 100, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Z_S_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages_1000328' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation Création d''Article'));
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Validation des Messages_1000328' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Validation Création d''Article')), name = 'Sous Famille', description = 'Sous familles', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 90, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'Y', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Z_S_Famille_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Validation des Messages_1000328' and ad_window_id in (select ad_window_id from ad_window where value = 'Validation Création d''Article'));
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Activité', description = '', displaylength = 22, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 90, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'Y', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'Z_PosWfActivity_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_PosWfActivity_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','Activité'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_PosWfActivity_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_PosWfActivity_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Activité'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Z_PosWfActivity_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
...
insert into AD_Field (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,ad_column_id,ad_fieldgroup_id, ad_tab_id, name, description, displaylength, displaylogic, entitytype, help, obscuretype, seqno, sortno, isactive, iscentrallymaintained, isdisplayed, isencrypted, isfieldonly, isheading, isreadonly, issameline,AD_REFERENCE_ID,ISMANDATORYUI,DEFAULTVALUE,ISDEFAULTFOCUS,MRSEQNO) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Field'),(select ad_column_id from ad_column where columnname = 'InitialMsgID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')),(select AD_FieldGroup_ID from AD_FieldGroup where Name = ''),
(select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')),
'Id du Message Initial',
'',
0,
...
0
 from dual  
where not exists (select 1 from AD_Field where ad_column_id = (select ad_column_id from ad_column where columnname = 'InitialMsgID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages')));

update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = ''), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Transactions Messages' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Transactions Messages')), name = 'Id du Message Initial', description = '', displaylength = 0, displaylogic = '', entitytype = 'E005', help = '', obscuretype = '', seqno = 330, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
where ad_column_id = (select ad_column_id from ad_column where columnname = 'InitialMsgID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg'))  and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'));

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'InitialMsgID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'nl_BE', 'Y', '','','Id du Message Initial'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'InitialMsgID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Help = '',Name = 'Id du Message Initial' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'InitialMsgID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'nl_BE';

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'InitialMsgID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))), 'fr_FR', 'Y', '','','Id du Message Initial'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'InitialMsgID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'Z_TransactionMsg')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Transactions Messages' and ad_window_id in (select ad_window_id from ad_window where value = 'Transactions Messages'))) and ad_language = 'fr_FR');
