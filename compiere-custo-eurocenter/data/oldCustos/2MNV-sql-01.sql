...
update AD_EntityType set Updated = sysdate, UpdatedBy = 0, name = '2MNV- 86715: Import factures - Matching OA', description = '', help = 'Evolution #86715 (Entity Type : 2MNV) Import factures - Matching OA', isactive = 'Y', classpath = '', modelpackage = '', modelvalidationclasses = '', isregistered = 'N', version = '0', record_id = 0, processing = 'N', createcomponent = 'N', documentationtext = '', requirecompiereversion = '', requirecomponentversion = '', summary = '' 
...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'OA No document',Help = '',Name = 'OA No document',PO_Description = '',PO_Help = '',PO_Name = '',PO_PrintName = '',PrintName = 'OA No document' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='ZZ_PODocNo') and ad_language = 'fr_FR';
...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'OA No document',Help = '',Name = 'OA No document',PO_Description = '',PO_Help = '',PO_Name = '',PO_PrintName = '',PrintName = 'OA No document' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='ZZ_PODocNo') and ad_language = 'nl_NL';
...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Ligne commande d?achat',Help = '',Name = 'Ligne commande d?achat',PO_Description = '',PO_Help = '',PO_Name = '',PO_PrintName = '',PrintName = 'Ligne commande d?achat' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='C_OrderLinePO_ID') and ad_language = 'fr_FR';
...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Ligne commande d?achat',Help = '',Name = 'Ligne commande d?achat',PO_Description = '',PO_Help = '',PO_Name = '',PO_PrintName = '',PrintName = 'Ligne commande d?achat' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='C_OrderLinePO_ID') and ad_language = 'nl_NL';
...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Forcé matching',Help = '',Name = 'Forcé matching',PO_Description = '',PO_Help = '',PO_Name = '',PO_PrintName = '',PrintName = 'Forcé matching' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='IsForceToInvoice') and ad_language = 'fr_FR';
...
update AD_Element_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Forcé matching',Help = '',Name = 'Forcé matching',PO_Description = '',PO_Help = '',PO_Name = '',PO_PrintName = '',PrintName = 'Forcé matching' where AD_Element_ID in (select AD_Element_ID from AD_Element where ColumnName='IsForceToInvoice') and ad_language = 'nl_NL';
...
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='C_OrderPO_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')), 'fr_FR', 'Y', 'Purchase Order'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Purchase Order' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='C_OrderPO_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')) and ad_language = 'fr_FR';

insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='C_OrderPO_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')), 'nl_NL', 'Y', 'Purchase Order'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Purchase Order' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='C_OrderPO_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')) and ad_language = 'nl_NL';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='IsMatched' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')), 'fr_FR', 'Y', 'Matched'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Matched' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='IsMatched' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')) and ad_language = 'fr_FR';
...
update AD_Field set Updated = sysdate, UpdatedBy = 0, ad_fieldgroup_id = (select AD_FieldGroup_ID from AD_FieldGroup where Name = 'Ordre d''achat'), ad_tab_id = (select AD_Tab_ID from AD_Tab where Value = 'Invoice_510' and AD_Window_ID in (select AD_Window_ID from AD_Window where Value = 'Import Invoice_279')), name = 'Purchase Order', description = 'Purchase Order', displaylength = 0, displaylogic = '', entitytype = '2MNV', help = '', obscuretype = '', seqno = 700, sortno = 0, isactive = 'Y', iscentrallymaintained = 'Y', isdisplayed = 'Y', isencrypted = 'N', isfieldonly = 'N', isheading = 'N', isreadonly = 'N', issameline = 'N', AD_REFERENCE_ID = (select AD_Reference_ID from AD_Reference where Name = ''), ISMANDATORYUI = '', DEFAULTVALUE = '', ISDEFAULTFOCUS = 'N', MRSEQNO = 0 
...
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'C_OrderPO_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Invoice_510' and ad_window_id in (select ad_window_id from ad_window where value = 'Import Invoice_279'))), 'fr_FR', 'Y', 'Purchase Order','','Purchase Order'
 from dual  
...
update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Purchase Order',Help = '',Name = 'Purchase Order' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'C_OrderPO_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Invoice_510' and ad_window_id in (select ad_window_id from ad_window where value = 'Import Invoice_279'))) and ad_language = 'fr_FR';

insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'C_OrderPO_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Invoice_510' and ad_window_id in (select ad_window_id from ad_window where value = 'Import Invoice_279'))), 'nl_NL', 'Y', 'Purchase Order','','Purchase Order'
 from dual  
...
update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Forcé matching',Help = '',Name = 'Forcé matching' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsForceToInvoice' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Invoice_510' and ad_window_id in (select ad_window_id from ad_window where value = 'Import Invoice_279'))) and ad_language = 'fr_FR';
...
update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'OA No document',Help = '',Name = 'OA No document' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'ZZ_PODocNo' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Invoice_510' and ad_window_id in (select ad_window_id from ad_window where value = 'Import Invoice_279'))) and ad_language = 'fr_FR';
...
update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Ligne commande d?achat',Help = '',Name = 'Ligne commande d?achat' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'C_OrderLinePO_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'I_Invoice')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Invoice_510' and ad_window_id in (select ad_window_id from ad_window where value = 'Import Invoice_279'))) and ad_language = 'fr_FR';
