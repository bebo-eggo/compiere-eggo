...
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_EntityType'),'EG05','EG05 - Création OA à partir ODV',
'',
'',
'Y',
'',
...
update AD_EntityType set Updated = sysdate, UpdatedBy = 0, name = 'EG05 - Création OA à partir ODV', description = '', help = '', isactive = 'Y', classpath = '', modelpackage = '', modelvalidationclasses = '', isregistered = 'Y', version = '361', record_id = 0, processing = 'N', createcomponent = 'N', documentationtext = '', requirecompiereversion = '', requirecomponentversion = '', summary = '' 
...
update AD_Process set Updated = sysdate, UpdatedBy = 0, accesslevel = '3', ad_printformat_id = (select AD_PrintFormat_ID from AD_PrintFormat where Name = ''), ad_reportview_id = (select AD_ReportView_ID from AD_ReportView where Name = '*None*'), ad_workflow_id = (select AD_Workflow_ID from AD_Workflow where Name = ''), classname = 'com.audaxis.compiere.eurocenter.process.OrderPOCreateEggo', description = '', entitytype = 'EG05', help = '', jasperreport = '', procedurename = '', name = 'Création Ordre d''achat Eggo', workflowvalue = '', isactive = 'Y', isbetafunctionality = 'N', isdirectprint = 'N', isreport = 'N', isserverprocess = 'N', AD_CTXAREA_ID = (select AD_CtxArea_ID from AD_CtxArea where Name = ''), ad_bview_id = (select AD_BView_ID from AD_BView where Name = ''), ad_reporttemplate_id = (select AD_ReportTemplate_ID from AD_ReportTemplate where Name = ''), isexternal = 'N' 
...
select 0,0,sysdate, sysdate,0,0,(select AD_Process_ID from AD_Process where Value='EG_CreatePO'), 'nl_BE', 'Y', '','','Création Ordre d''achat Eggo'
 from dual  
...
update AD_Process_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Help = '',Name = 'Création Ordre d''achat Eggo' where AD_Process_ID in (select AD_Process_ID from AD_Process where Value='EG_CreatePO') and ad_language = 'nl_BE';

insert into AD_Process_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Process_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Process_ID from AD_Process where Value='EG_CreatePO'), 'fr_FR', 'Y', '','','Création Ordre d''achat Eggo'
 from dual  
...
update AD_Process_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Help = '',Name = 'Création Ordre d''achat Eggo' where AD_Process_ID in (select AD_Process_ID from AD_Process where Value='EG_CreatePO') and ad_language = 'fr_FR';
...
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Form'),'Création OA à partir d''ODV','3',
'',
'Création OA à partir d''ODV',
'EG05',
'',
'Y',
'N',
...
'org.compiere.gwt.server.window.GeneratePoWindowImpl'
 from dual  
where not exists (select 1 from AD_Form where Name = 'Création OA à partir d''ODV' );

update AD_Form set Updated = sysdate, UpdatedBy = 0, accesslevel = '3', classname = '', description = 'Création OA à partir d''ODV', entitytype = 'EG05', help = '', isactive = 'Y', isbetafunctionality = 'N', JSPURL = '', AD_CTXAREA_ID = (select AD_CtxArea_ID from AD_CtxArea where Name = ''), WebClassname = 'org.compiere.gwt.server.window.GeneratePoWindowImpl' 
where Name = 'Création OA à partir d''ODV' ;
...
select 0,0,sysdate, sysdate,0,0,(select AD_Form_ID from AD_Form where Name='Création OA à partir d''ODV'), 'nl_BE', 'Y', '','','Création OA à partir d''ODV'
 from dual  
where not exists (select 1 from AD_Form_Trl where AD_Form_ID in (select AD_Form_ID from AD_Form where Name='Création OA à partir d''ODV') and ad_language = 'nl_BE');

update AD_Form_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Help = '',Name = 'Création OA à partir d''ODV' where AD_Form_ID in (select AD_Form_ID from AD_Form where Name='Création OA à partir d''ODV') and ad_language = 'nl_BE';

insert into AD_Form_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Form_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Form_ID from AD_Form where Name='Création OA à partir d''ODV'), 'fr_FR', 'Y', '','','Création OA à partir d''ODV'
 from dual  
where not exists (select 1 from AD_Form_Trl where AD_Form_ID in (select AD_Form_ID from AD_Form where Name='Création OA à partir d''ODV') and ad_language = 'fr_FR');

update AD_Form_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Help = '',Name = 'Création OA à partir d''ODV' where AD_Form_ID in (select AD_Form_ID from AD_Form where Name='Création OA à partir d''ODV') and ad_language = 'fr_FR';

insert into AD_Menu (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Menu_ID,Value,name, action, description, entitytype, ad_form_id, ad_process_id, ad_task_id, ad_window_id, ad_workbench_id, ad_workflow_id, isactive, isreadonly, issummary) 
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Menu'),'CreateOAODV','Création d''OA à partir d''ODV',
'X',
'',
'EG05',
(select AD_Form_ID from AD_Form where Name = 'Création OA à partir d''ODV'),
(select AD_Process_ID from AD_Process where Value = ''),
...
update AD_Menu set Updated = sysdate, UpdatedBy = 0, name = 'Création d''OA à partir d''ODV', action = 'X', description = '', entitytype = 'EG05', ad_form_id = (select AD_Form_ID from AD_Form where Name = 'Création OA à partir d''ODV'), ad_process_id = (select AD_Process_ID from AD_Process where Value = ''), ad_task_id = (select AD_Task_ID from AD_Task where Name = ''), ad_window_id = (select AD_Window_ID from AD_Window where Value = ''), ad_workbench_id = (select AD_Workbench_ID from AD_Workbench where Name = ''), ad_workflow_id = (select AD_Workflow_ID from AD_Workflow where Name = ''), isactive = 'Y', isreadonly = 'N', issummary = 'N' 
where Value = 'CreateOAODV' ;

insert into AD_Menu_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Menu_ID,AD_Language, IsTranslated,Description,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Menu_ID from AD_Menu where Value='CreateOAODV'), 'nl_BE', 'Y', '','Création d''OA à partir d''ODV'
 from dual  
...
update AD_Menu_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Name = 'Création d''OA à partir d''ODV' where AD_Menu_ID in (select AD_Menu_ID from AD_Menu where Value='CreateOAODV') and ad_language = 'nl_BE';

insert into AD_Menu_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Menu_ID,AD_Language, IsTranslated,Description,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Menu_ID from AD_Menu where Value='CreateOAODV'), 'fr_FR', 'Y', '','Création d''OA à partir d''ODV'
 from dual  
...
update AD_Menu_Trl set Updated = sysdate, UpdatedBy = 0,Description = '',Name = 'Création d''OA à partir d''ODV' where AD_Menu_ID in (select AD_Menu_ID from AD_Menu where Value='CreateOAODV') and ad_language = 'fr_FR';
