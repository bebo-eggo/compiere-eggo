...
insert into AD_Process_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Process_ID,AD_Language, IsTranslated,Name,Help,Description) 
select 0,0,sysdate, sysdate,0,0,(select AD_Process_ID from AD_Process where Value='SyncProductPrice'), 'fr_FR', 'Y', 'Synchro prix articles','',''
 from dual  
...
update AD_Process_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Synchro prix articles',Help = '',Description = '' where AD_Process_ID in (select AD_Process_ID from AD_Process where Value='SyncProductPrice') and ad_language = 'fr_FR';

insert into AD_Process_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Process_ID,AD_Language, IsTranslated,Name,Help,Description) 
select 0,0,sysdate, sysdate,0,0,(select AD_Process_ID from AD_Process where Value='SyncProductPrice'), 'nl_NL', 'Y', 'Synchro prix articles','',''
 from dual  
...
update AD_Process_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Synchro prix articles',Help = '',Description = '' where AD_Process_ID in (select AD_Process_ID from AD_Process where Value='SyncProductPrice') and ad_language = 'nl_NL';
...
select 0,0,sysdate, sysdate,0,0,AD_Sequence_NextNo('AD_Menu'),'Synchro prix articles','Synchro prix articles',
'P',
'',
'2685',
...
update AD_Menu set Updated = sysdate, UpdatedBy = 0, name = 'Synchro prix articles', action = 'P', description = '', entitytype = '2685', ad_form_id = (select AD_Form_ID from AD_Form where Name = ''), ad_process_id = (select AD_Process_ID from AD_Process where Value = 'SyncProductPrice'), ad_task_id = (select AD_Task_ID from AD_Task where Name = ''), ad_window_id = (select AD_Window_ID from AD_Window where Value = ''), ad_workbench_id = (select AD_Workbench_ID from AD_Workbench where Name = ''), ad_workflow_id = (select AD_Workflow_ID from AD_Workflow where Name = ''), isactive = 'Y', isreadonly = 'N', issummary = 'N' 
