...
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='Created' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')), 'fr_FR', 'Y', 'Créé'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Créé' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Created' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='EntityType' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')), 'fr_FR', 'Y', 'Type entité'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Type entité' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='EntityType' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='EntityType' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Type entité'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Type entité' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='EntityType' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='AD_Client_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')), 'fr_FR', 'Y', 'Société'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Société' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='AD_Client_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='Updated' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')), 'fr_FR', 'Y', 'Modifié'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Modifié' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Updated' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='CreatedBy' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')), 'fr_FR', 'Y', 'Créée par'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Créée par' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='CreatedBy' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='UpdatedBy' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')), 'fr_FR', 'Y', 'Modifié par'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Modifié par' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='UpdatedBy' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='AD_Reference_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Référence'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Référence' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='AD_Reference_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='AD_Client_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Société'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Société' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='AD_Client_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='Created' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Créé'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Créé' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Created' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='Updated' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Modifié'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Modifié' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='Updated' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='CreatedBy' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Créée par'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Créée par' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='CreatedBy' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='UpdatedBy' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Modifié par'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Modifié par' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='UpdatedBy' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='AD_Window_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Fenêtre'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Fenêtre' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='AD_Window_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='IsDisplayed' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Affiché'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Affiché' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='IsDisplayed' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='SeqNo' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Séquence'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Séquence' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='SeqNo' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='AD_Reference_Value_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Valeur de référence'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Valeur de référence' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='AD_Reference_Value_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
insert into AD_Column_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Column_ID,AD_Language, IsTranslated,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Column_ID from AD_Column where ColumnName='AD_Element_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')), 'fr_FR', 'Y', 'Elément'
 from dual  
...
update AD_Column_Trl set Updated = sysdate, UpdatedBy = 0,Name = 'Elément' where AD_Column_ID in (select AD_Column_ID from AD_Column where ColumnName='AD_Element_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_language = 'fr_FR';
...
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'C_DocType_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'C_DocType_Trl')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Translation_230' and ad_window_id in (select ad_window_id from ad_window where value = 'Document Type_135'))), 'fr_FR', 'Y', 'Type Document','Détermine la séquence du document  et le mode de traitement.','Type document'
 from dual  
...
update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Type Document',Help = 'Détermine la séquence du document  et le mode de traitement.',Name = 'Type document' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'C_DocType_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'C_DocType_Trl')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Translation_230' and ad_window_id in (select ad_window_id from ad_window where value = 'Document Type_135'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'DisplayLogic' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Si le champ est affiché, le résultat détermine si le champ sur affiché.','format		:= <expression> [<logic> <expression>] expression	:= @<context>@=<value> or @<context>@!<value> logic		:= <|>|<&'||'>	context		:= any global or window context value		:= strings logic operators	:= AND or OR with the prevoius result from left to right Example	''@AD_Table_ID@=14 | @Language@!''GERGER'' As it is always a string comparison, the string delimiters are optional, but suggested for future compability','Logique d''affichage'
 from dual  
...
update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Si le champ est affiché, le résultat détermine si le champ sur affiché.',Help = 'format		:= <expression> [<logic> <expression>] expression	:= @<context>@=<value> or @<context>@!<value> logic		:= <|>|<&'||'>	context		:= any global or window context value		:= strings logic operators	:= AND or OR with the prevoius result from left to right Example	''@AD_Table_ID@=14 | @Language@!''GERGER'' As it is always a string comparison, the string delimiters are optional, but suggested for future compability',Name = 'Logique d''affichage' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'DisplayLogic' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'SeqNo' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Méthode de tri des données. Le n° le plus petit est affiché en 1er','Définit l''ordre des données.','Séquence'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'SeqNo' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsDisplayed' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Détermine si le champ est affiché','Si le champ est affiché, la logique d''impression déterminera au runtime si il affichera le champ','Affiché'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsDisplayed' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Détermine si le champ est affiché',Help = 'Si le champ est affiché, la logique d''impression déterminera au runtime si il affichera le champ',Name = 'Affiché' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsDisplayed' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Reference_Value_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'A définir, si le type de données est table ou liste','La valeur de référence identifie l''endroit où sont stocké les valeurs de références. Cela doit être spécifié si le type de données est Table ou liste. ','Valeur de référence'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Reference_Value_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'A définir, si le type de données est table ou liste',Help = 'La valeur de référence identifie l''endroit où sont stocké les valeurs de références. Cela doit être spécifié si le type de données est Table ou liste. ',Name = 'Valeur de référence' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Reference_Value_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Element_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Les éléments du système permettent une maintenance centralisée des descriptions des colonnes et des aides','Les éléments du système permettent une maintenance centralisée des description, des aides et de la terminologie au niveau des colonnes de la base de données','Elément'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Element_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Les éléments du système permettent une maintenance centralisée des descriptions des colonnes et des aides',Help = 'Les éléments du système permettent une maintenance centralisée des description, des aides et de la terminologie au niveau des colonnes de la base de données',Name = 'Elément' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Element_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'EntityType' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info_1108' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Type entité dictionnaire. Détermine la propriété et la synchronisation','L''entité de type dictionnaire, Compiere et application peuvent être automatiquement synchronisée et les customisations supprimées ou réimportées. Pour les customisations, copier l''entité et sélectionner le type ''User''','Type entité'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'EntityType' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info_1108' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Type entité dictionnaire. Détermine la propriété et la synchronisation',Help = 'L''entité de type dictionnaire, Compiere et application peuvent être automatiquement synchronisée et les customisations supprimées ou réimportées. Pour les customisations, copier l''entité et sélectionner le type ''User''',Name = 'Type entité' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'EntityType' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info_1108' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'EntityType' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Type entité dictionnaire. Détermine la propriété et la synchronisation','L''entité de type dictionnaire, Compiere et application peuvent être automatiquement synchronisée et les customisations supprimées ou réimportées. Pour les customisations, copier l''entité et sélectionner le type ''User''','Type entité'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'EntityType' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'SelectClause' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Clause SQL Select','La clause Select indique la clause SQL à utiliser pour déterminer l''article dans la mesure de performance','Clause Select'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'SelectClause' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Clause SQL Select',Help = 'La clause Select indique la clause SQL à utiliser pour déterminer l''article dans la mesure de performance',Name = 'Clause Select' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'SelectClause' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'WhereClause' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Clause SQL WHERE complète','Identifie la partie de la clause SQL correspondant à WHERE à utiliser pour la sélection d''enregistrement','Clause SQL '
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'WhereClause' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Clause SQL WHERE complète',Help = 'Identifie la partie de la clause SQL correspondant à WHERE à utiliser pour la sélection d''enregistrement',Name = 'Clause SQL ' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'WhereClause' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Name' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info_1108' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Identification alphanumï¿½rique de l''entitï¿½','Le nom de l''entitï¿½ (enregistrement) est utilisï¿½ comme clï¿½ de recherche par dï¿½faut en complï¿½ment de la clï¿½ de recherche. La longueur maximale permise est de 60 caractï¿½res.','Nom'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Name' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info_1108' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Org_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info_1108' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Etablissement au sein d''une société','une unité est une partie d''une société, (établissement, succursale, bureau, etc...).','Organisation'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Org_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info_1108' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Client_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info_1108' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Nom de l''entreprise titulaire de la base de données (DB)','','Société'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Client_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfo')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info_1108' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsActive' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'L''enregistrement est actif dans le système','Il a deux méthodes pour rendre inactif un enregistrement dans le système: la première est de désactiver l''enregistrement, l''autre est de désactiver l''enregistrement. La désactivation rend l''enregistrement non valide au niveau des sélections mais bien au niveau des éditions. Il y a deux raisons pour désactiver plutôt que supprimer un enregistrement: la première est pour des raisons d''audit. La seconde est que les données sont liées. Par exemple, vous ne pouvez pas supprimer un tiers si il existe des factures pour ce dernier. En désactivant le tiers, vous ne pouvez plus enregistrer de facture pour celui-ci.','Actif'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'IsActive' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Name' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Identification alphanumï¿½rique de l''entitï¿½','Le nom de l''entitï¿½ (enregistrement) est utilisï¿½ comme clï¿½ de recherche par dï¿½faut en complï¿½ment de la clï¿½ de recherche. La longueur maximale permise est de 60 caractï¿½res.','Nom'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'Name' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Org_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Etablissement au sein d''une société','une unité est une partie d''une société, (établissement, succursale, bureau, etc...).','Organisation'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Org_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Reference_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Référence système','La référence indique le type de champ référence','Référence'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Reference_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Référence système',Help = 'La référence indique le type de champ référence',Name = 'Référence' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Reference_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Tab_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Onglet d''une fenêtre ','L''onglet représente celui qui s''affiche pour chaque fenêtre du système','Onglet'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Tab_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Onglet d''une fenêtre ',Help = 'L''onglet représente celui qui s''affiche pour chaque fenêtre du système',Name = 'Onglet' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Tab_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR';
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Client_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Nom de l''entreprise titulaire de la base de données (DB)','','Société'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Client_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');
...
insert into AD_Field_Trl (AD_Client_ID, AD_Org_ID, Updated, Created, UpdatedBy, CreatedBy,AD_Field_ID,AD_Language, IsTranslated,Description,Help,Name) 
select 0,0,sysdate, sysdate,0,0,(select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Window_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))), 'fr_FR', 'Y', 'Fenêtre de saisie des données','La fenêtre identifie une fenêtre unique dans le système','Fenêtre'
 from dual  
where not exists (select 1 from AD_Field_Trl where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Window_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR');

update AD_Field_Trl set Updated = sysdate, UpdatedBy = 0,Description = 'Fenêtre de saisie des données',Help = 'La fenêtre identifie une fenêtre unique dans le système',Name = 'Fenêtre' where AD_Field_ID in (select AD_Field_ID from AD_Field where ad_column_id=(select ad_column_id from ad_column where columnname = 'AD_Window_ID' and ad_table_id in (select ad_table_id from ad_table where tablename = 'AD_QuickInfoLine')) and ad_tab_id in (select ad_tab_id from ad_tab where value = 'Quick Info Line_1109' and ad_window_id in (select ad_window_id from ad_window where value = 'Quick Info_473'))) and ad_language = 'fr_FR';
